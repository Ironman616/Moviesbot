...
URL = "https://movieloverzz-movieloverzz.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movieloverzz-movieloverzz.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movieloverzz-movieloverzz.koyeb.app/".format(FQDN)
else:
    URL = "https://movieloverzz-movieloverzz.koyeb.app/".format(FQDN)
