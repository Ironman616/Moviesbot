...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001722166824')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002076477693')).split()]
...
URL = "https://movieloverzzbot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movieloverzzbot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movieloverzzbot.onrender.com/".format(FQDN)
else:
    URL = "https://movieloverzzbot.onrender.com/".format(FQDN)
