...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS','949657126').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+8vi7ZMabJjk3ZWU1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Movie_loverzz')
TUTORIAL = environ.get('TUTORIAL', 'https://movie_loverzz')
...
URL = "https://movieloverzzbot-movieloverzzbot.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movieloverzzbot-movieloverzzbot.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movieloverzzbot-movieloverzzbot.koyeb.app/".format(FQDN)
else:
    URL = "https://movieloverzzbot-movieloverzzbot.koyeb.app/".format(FQDN)
